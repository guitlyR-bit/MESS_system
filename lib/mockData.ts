...
export const MOCK_CLUB_PROFILE: Club = {
  ...
  multisport_coverage_amount: 150,
  accepts_benefit_cards: true,
  benefit_cards_description: 'Sodexo, Edenred, Up',
  profile_accent_color: '#EAB308',
  allows_dogs: false,
